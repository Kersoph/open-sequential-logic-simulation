...
namespace Osls.SfcSimulation.Viewer
{
    ...
    public class SfcSimulationViewer : PageModule
    {
        ...
        /// </summary>
        private Sfc2dEditorNode InitialiseDiagram(ILessonEntity openedLesson)
        {
            Sfc2dEditorNode sfc2dEditorNode = GetNode<Sfc2dEditorNode>("HscRelative/Sfc2dViewer/Sfc2dEditor");
            sfc2dEditorNode.InitializeEditor(_processingData, false);
            string filepath = openedLesson.TemporaryDiagramFilePath;
            sfc2dEditorNode.TryLoadDiagram(filepath);
            return sfc2dEditorNode;
        }
